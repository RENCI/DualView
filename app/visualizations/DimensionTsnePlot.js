...
module.exports = function () {
  ...
  var margin = { top: 20, left: 20, bottom: 20, right: 20 },
      ...
      // Event dispatcher
      dispatcher = d3.dispatch("selectDimension", "highlightDimension");

  function dimensionTsnePlot(selection) {
    selection.each(function(d) {
          ...
          .on("drag", function() {
            ...
            data.forEach(function(d) {
              ...
              if (selected !== d.selected) {
                ...
                dispatcher.call("selectDimension", this, d);
              }
            });
          })
          .on("end", function() {
      ...
      var svgEnter = svg.enter().append("svg")
          .attr("class", "dimensionTsnePlot")
          .on("mousedown", function() {
            // Stop text highlighting
            d3.event.preventDefault();
          })
          .on("dblclick", function() {
            dispatcher.call("selectDimension", this, null);
          })
          .call(drag);
...
//    drawLinks();
    ...
    function title(d) {
      return d.connection ? (d.name + ", p value: " + d.connection.pValue) : d.name;
    }
...
//      return d.connection ? strokeScale(d.connection.extremeness) : strokeScale(0.5);
  ...
  dimensionTsnePlot.width = function(_) {
    if (!arguments.length) return width;
    width = _;
    return dimensionTsnePlot;
  };

  dimensionTsnePlot.height = function(_) {
  ...
  dimensionTsnePlot.on = function() {
    var value = dispatcher.on.apply(dispatcher, arguments);
    return value === dispatcher ? dimensionTsnePlot : value;
  };
